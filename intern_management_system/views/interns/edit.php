...
<div class="card card-body bg-light mt-5">
    <h2>Chỉnh sửa hồ sơ thực tập sinh</h2>
    <p>Chỉnh sửa hồ sơ thực tập sinh</p>
    <form action="<?php echo BASE_URL; ?>interns/edit/<?php echo $data['id']; ?>" method="post">
        ...
        <input type="submit" class="btn btn-success" value="Cập nhật hồ sơ">
    </form>
</div>
