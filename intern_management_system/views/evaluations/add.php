...
<div class="card card-body bg-light mt-5">
    <h2>Thêm đánh giá thực tập sinh mới</h2>
    <p>Tạo một đánh giá hiệu suất mới cho thực tập sinh</p>
    <form action="<?php echo BASE_URL; ?>internevaluations/add" method="post">
        ...
        <input type="submit" class="btn btn-success" value="Thêm đánh giá">
    </form>
</div>
