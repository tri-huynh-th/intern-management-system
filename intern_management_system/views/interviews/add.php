...
<div class="card card-body bg-light mt-5">
    <h2>Thêm lịch phỏng vấn mới</h2>
    <p>Tạo một lịch phỏng vấn mới</p>
    <form action="<?php echo BASE_URL; ?>interviewschedules/add" method="post">
        ...
        <input type="submit" class="btn btn-success" value="Thêm lịch phỏng vấn">
    </form>
</div>
