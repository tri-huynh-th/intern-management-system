...
<div class="card card-body bg-light mt-5">
    <h2>Chỉnh sửa chương trình đào tạo</h2>
    <p>Chỉnh sửa chương trình đào tạo hiện có</p>
    <form action="<?php echo BASE_URL; ?>trainingprograms/edit/<?php echo $data['id']; ?>" method="post">
        ...
        <input type="submit" class="btn btn-success" value="Cập nhật chương trình">
    </form>
</div>
